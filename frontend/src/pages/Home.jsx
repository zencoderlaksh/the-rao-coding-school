  ...
  return (
    <section data-scroll-section className="pt-40">
      ...
      >
        ...
        {/* COURSES */}
        <section className="courses-section min-h-screen p-20">
        ...
        {/* WHY US */}
        <section className="why-section min-h-screen p-20 flex flex-col justify-center">
        ...
        {/* ENQUIRY CTA */}
        <section className="cta-section min-h-screen p-20 flex items-center justify-center">
